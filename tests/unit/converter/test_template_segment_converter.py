...
async def test_template_segment_converter_convert_short_prompt_with_fewer_words_than_parameters():
    """Test conversion when the prompt has fewer words than template parameters."""
    template = SeedPrompt(
        value="""
        First: {{ part1 }}
        Second: {{ part2 }}
